...
print("Stahuji ide_c3.tar")
wget(url="http://iotserver.cz/ide/ide_c3.tar",path="")

print("Stahuji install_c3.py")
wget(url="http://iotserver.cz/ide/install_c3.py",path="")

print("Spoustim instalator...")
import install_c3.py
